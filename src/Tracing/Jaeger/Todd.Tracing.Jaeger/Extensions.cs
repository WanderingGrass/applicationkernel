...
public static class Extensions
{
    ...
    public static IApplicationKernelBuilder AddJaeger(this IApplicationKernelBuilder builder, string sectionName = SectionName,
    ...
    public static IApplicationKernelBuilder AddJaeger(this IApplicationKernelBuilder builder,
    ...
    public static IApplicationKernelBuilder AddJaeger(this IApplicationKernelBuilder builder, JaegerOptions options,
