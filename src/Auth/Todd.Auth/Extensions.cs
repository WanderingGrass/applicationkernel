...
public static class Extensions
{
    ...
    public static IApplicationKernelBuilder AddJwt(this IApplicationKernelBuilder builder, string sectionName = SectionName,
    ...
    private static IApplicationKernelBuilder AddJwt(this IApplicationKernelBuilder builder, JwtOptions options,
        Action<JwtBearerOptions> optionsFactory = null)
    {
