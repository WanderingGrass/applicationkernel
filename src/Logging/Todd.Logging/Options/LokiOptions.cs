...
namespace Todd.ApplicationKernel.Logging.Options;

/// <summary>
/// Relevant options for the Serilog Loki sink
/// <para></para>
/// Not all options have been included as some have been covered by Todd.ApplicationKernel.Logging already.
